            ...
            <table class="bg-cyan-100 border-separate border-2 border-gray-500 w-3/5 rounded-md">
                ...
                <tr>
                    ...
                    <td class="border border-gray-400"><p class="text-center"></p>
                        <div>
                            <input id="name" type="text" name="user[name]" required value="{{ Auth::user()->name }}" class="flex w-full p-2.5 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="例：アマスポ太郎"></input>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="border border-gray-400">
                        <input id="email" name="user[email]" rows="4" required value="{{ Auth::user()->email }}" class="w-full mt-auto mb-auto flex text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                    </td>
                </tr>
                <tr>
                    <th class="border border-gray-400">ホームタウン</th>
                    <td class="border border-gray-400">
                        <input id="hometown" type="text" name="user[hometown]" required value="{{ Auth::user()->hometown }}" class="flex w-full p-2.5 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="例：東京都世田谷区"></input>
                    </td>
                </tr>
                <tr>
                    <th class="border border-gray-400">電話番号</th>
                    <td class="border border-gray-400">
                        <input id="telephone" type="tel" name="user[telephone]" required value="{{ Auth::user()->telephone }}" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{3,4}" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="半角数字、ハイフン必須"></input>
                    </td>
                </tr>
                <tr>
                    <th class="border border-gray-400">年齢</th>
                    <td class="border border-gray-400">
                        <input id="age" type="number" name="user[age]" required value="{{ Auth::user()->age }}" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="半角数字"></input>
                    </td>
                </tr>
            </table>
        </div>

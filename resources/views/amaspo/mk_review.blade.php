<x-app-layout>
    ...
    <form action="{{ route('str_review') }}" method="POST">
        ...
        <div class="flex justify-center">
            <table class="bg-cyan-100 border-separate border-2 border-gray-700 w-3/5 rounded-md">
                <tr>
                    <th class="w-2/6 border border-gray-600 py-2">項目</th>
                    <th class="w-4/6 border border-gray-600">内容</th>
                </tr>
                <tr>
                ...
                <tr>
                    <th class="border border-gray-600 ">５段階評価</th>
                    <td class="border border-gray-600 pt-2"><p class="text-center"></p>
                        <div>
                            <div class="flex items-center mb-4">
                                <input id="evaluation" type="radio" name="evaluation" value="5" required class="w-4 h-4 ml-2 text-blue-600 bg-gray-100 rounded border-gray-500 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="evaluation" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">⭐⭐️⭐⭐️⭐</label>
                            </div>
                            <div class="flex items-center mb-4">
                                <input id="evaluation" type="radio" name="evaluation" value="4" required class="w-4 h-4 ml-2 text-blue-600 bg-gray-100 rounded border-gray-500 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="evaluation" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">⭐⭐️⭐️⭐</label>
                            </div>
                            <div class="flex items-center mb-4">
                                <input id="evaluation" type="radio" name="evaluation" value="3" required class="w-4 h-4 ml-2 text-blue-600 bg-gray-100 rounded border-gray-500 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="evaluation" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">⭐⭐️⭐</label>
                            </div>
                            <div class="flex items-center mb-4">
                                <input id="evaluation" type="radio" name="evaluation" value="2" required class="w-4 h-4 ml-2 text-blue-600 bg-gray-100 rounded border-gray-500 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="evaluation" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">⭐️⭐</label>
                            </div>
                            <div class="flex items-center mb-4">
                                <input id="evaluation" type="radio" name="evaluation" value="1" required class="w-4 h-4 ml-2 text-blue-600 bg-gray-100 rounded border-gray-500 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="evaluation" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">️⭐</label>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    <th class="border border-gray-600">コメント</th>
